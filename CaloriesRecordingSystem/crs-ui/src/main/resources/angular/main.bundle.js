...
var sortedActvities = prefix + 'sortedByBC';
...
var ActivityService = /** @class */ (function () {
    ...
    ActivityService.prototype.getSortedActivities = function () {
        return this.http
            .get(sortedActvities);
    };
...
var ActivityDetailFormComponent = /** @class */ (function () {
    function ActivityDetailFormComponent(activityService, categoryService, location, route, router) {
    ...
    ActivityDetailFormComponent.prototype.saveActivityDetails = function () {
        ...
        this.activityService
            ...
            var category = activity.category, other = __rest(activity, ["category"]);
            _this.activity = Object.assign({}, __assign({}, other, { category: category.id }));
            _this.router.navigateByUrl('activities');
        });
    };
...
var ActivityListComponent = /** @class */ (function () {
    ...
    ActivityListComponent.prototype.loadSortedActivities = function () {
        var _this = this;
        this.activityService
            .getSortedActivities()
            .subscribe(function (activities) {
...
var RecordFormComponent = /** @class */ (function () {
    ...
    RecordFormComponent.prototype.updateRecord = function () {
        ...
        this.recordService
            ...
            .subscribe(function (_) { return _this.router.navigateByUrl('records'); });
    };
...
var TrackingSettingsComponent = /** @class */ (function () {
    function TrackingSettingsComponent(userService, router) {
    ...
    TrackingSettingsComponent.prototype.saveTrackingSettings = function () {
        ...
        this.userService
            ...
            .subscribe(function (trackingSettings) {
            _this.trackingSettings = trackingSettings;
            _this.router.navigateByUrl('records');
        });
    };
